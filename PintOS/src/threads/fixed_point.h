...
fixed_point fp_addition (fixed_t fp1, fixed_t fp2);

// Substract fp2 from fp1.
fixed_t fp_substraction (fixed_t fp1, fixed_t fp2);

// Add integer to fixed point.
fixed_t fp_add_int_and_fp (int integer, fixed_t fp);

// Substract integer from fixed point.
fixed_t fp_fp_minus_int (fixed_t fp, int integer);
